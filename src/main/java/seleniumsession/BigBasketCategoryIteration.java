...
public class BigBasketCategoryIteration {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> level2list = driver.findElements(By.xpath("(//ul[contains(@class,'nav-stacked')])[last()]//a"));
		for(WebElement e2 : level2list) {
			act.moveToElement(e2).perform();
			System.out.println(e2.getText());
			
			
		List<WebElement> level3list = driver.findElements(By.xpath("(//div[@class='box']//ul[@class='list-unstyled'])[last()-1]//a"));
